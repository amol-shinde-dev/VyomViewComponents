...
angular.module('com.bmc.arsys.rx.standardlib.utils').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('scripts/view-components/card-widget/com-vyom-vyomlib-card-widget-design.directive.html',
    "<div class=\"row\"><div class=\"col-lg-4\"><span class=\"d-icon-widget\" style=\"font-size: 100px;text-align: center\"></span></div><div><h3>Use this component when you want to display only 3 cards on a view.</h3></div></div>"
  );


  $templateCache.put('scripts/view-components/card-widget/com-vyom-vyomlib-card-widget.directive.html',
    "<!DOCTYPE HTML><html><head><meta charset=\"utf-8\"><meta http-equiv=\"x-ua-compatible\" content=\"ie=edge\"><title>Card widget View</title><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head><body><div class=\"all-content-wrapper\" style=\"display: flex;flex-wrap: wrap\"><div class=\"col-lg-4 col-md-4 col-sm-4 col-xs-12\" style=\"padding: 1px;display: flex\"><div class=\"analytics-sparkle-line reso-mg-b-30 w3-{{Color1}}\" style=\"display: flex;flex-direction: column;flex:1\" tabindex=\"0\"><div class=\"analytics-content\" style=\"display: flex;flex-direction: row;justify-content: space-between\" ng-click=\"callAction('Saction')\" role=\"button\"><div style=\"display: flex;flex-direction: column;flex: 1\"><h3 style=\"font-size:{{countSize}}em; color: #fff;margin: 0.3em 0em;font-family: 'Carrois Gothic', sans-serif\">{{rxConfiguration.propertiesByName.count1 | comVyomVyomlibMyFilter}}</h3><h4 style=\"font-size: 1.5em; color: #fff;margin: 0.3em 0em;font-family: 'Carrois Gothic', sans-serif\">{{header1}}</h4><p>{{note1}}</p></div><div style=\"display: flex;flex-direction: column;flex: 0 0 120px\"><img style=\"height: {{imageHeight}}px;width: {{imageWidth}}px\" src=\"{{pictureData1}}\"></div></div><div class=\"analytics-content\" ng-style=\"{display: tooltip === 'Show' ? 'flex' : 'none'}\" style=\"flex-direction: row;margin-top: auto\"><p class=\"d-icon-info_circle\" style=\"font-size: small;margin: 5px\"><span class=\"col-lg-11 col-md-10 col-xs-10 tooltiptext\">{{tooltip1}}</span></p></div></div></div><div class=\"col-lg-4 col-md-4 col-sm-4 col-xs-12\" style=\"padding: 1px;display: flex\"><div class=\"analytics-sparkle-line reso-mg-b-30 w3-{{Color2}}\" style=\"display: flex;flex-direction: column;flex:1\" tabindex=\"0\"><div class=\"analytics-content\" style=\"display: flex;flex-direction: row;justify-content: space-between\" ng-click=\"callAction('Iaction')\" role=\"button\"><div style=\"display: flex;flex-direction: column;flex: 1\"><h3 style=\"font-size:{{countSize}}em;color: #fff;margin: 0.3em 0em;font-family: 'Carrois Gothic', sans-serif\">{{rxConfiguration.propertiesByName.count2 | comVyomVyomlibMyFilter}}</h3><h4 style=\"font-size: 1.5em; color: #fff;margin: 0.3em 0em;font-family: 'Carrois Gothic', sans-serif\">{{header2}}</h4><p>{{note2}}</p></div><div style=\"display: flex;flex-direction: column;flex: 0 0 120px\"><img style=\"height: {{imageHeight}}px;width: {{imageWidth}}px\" src=\"{{pictureData2}}\"></div></div><div class=\"analytics-content\" ng-style=\"{display: tooltip === 'Show' ? 'flex' : 'none'}\" style=\"flex-direction: row;margin-top: auto\"><p class=\"d-icon-info_circle\" style=\"font-size: small;margin: 5px\"><span class=\"col-lg-11 col-md-10 col-xs-10 tooltiptext\">{{tooltip2}}</span></p></div></div></div><div class=\"col-lg-4 col-md-4 col-sm-4 col-xs-12\" style=\"padding: 1px;display: flex\"><div class=\"analytics-sparkle-line reso-mg-b-30 w3-{{Color3}}\" style=\"display: flex;flex-direction: column;flex:1\" tabindex=\"0\"><div class=\"analytics-content\" style=\"display: flex;flex-direction: row;justify-content: space-between\" ng-click=\"callAction('Caction')\" role=\"button\"><div style=\"display: flex;flex-direction: column;flex: 1\"><h3 style=\"font-size:{{countSize}}em; color: #fff;margin: 0.3em 0em;font-family: 'Carrois Gothic', sans-serif\">{{rxConfiguration.propertiesByName.count3 | comVyomVyomlibMyFilter}}</h3><h4 style=\"font-size: 1.5em; color: #fff;margin: 0.3em 0em;font-family: 'Carrois Gothic', sans-serif\">{{header3}}</h4><p>{{note3}}</p></div><div style=\"display: flex;flex-direction: column;flex: 0 0 120px\"><img style=\"height: {{imageHeight}}px;width: {{imageWidth}}px\" src=\"{{pictureData3}}\"></div></div><div class=\"analytics-content\" ng-style=\"{display: tooltip === 'Show' ? 'flex' : 'none'}\" style=\"flex-direction: row;margin-top: auto\"><p class=\"d-icon-info_circle\" style=\"font-size: small;margin: 5px\"><span class=\"col-lg-11 col-md-10 col-xs-10 tooltiptext\">{{tooltip3}}</span></p></div></div></div><div class=\"clearfix\"></div></div></body></html>"
  );
  ...
  $templateCache.put('scripts/view-components/custom-date-time-picker/com-vyom-vyomlib-custom-date-time-picker.directive.html',
    "<div class=\"d-textfield\" ng-class=\"rxConfiguration.propertiesByName.styles\"><span class=\"d-textfield__item\">{{rxConfiguration.propertiesByName.label}}</span><div class=\"rx-date-time\"><div class=\"date-field\"><div class=\"input-group\"><input type=\"text\" name=\"dt\" class=\"form-control\" uib-datepicker-popup ng-model=\"data.date\" is-open=\"status.opened\" datepicker-options=\"dateOptions\" ng-required=\"fieldDefinition.fieldOption == 'REQUIRED'\" show-button-bar=\"false\" ng-change=\"setOutput()\"> <span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default\" ng-click=\"open($event)\"><i class=\"d-icon-calendar\"></i></button></span></div></div><div class=\"time-field\"><div class=\"input-group\"><uib-timepicker ng-model=\"data.date\" ng-change=\"changed();setOutput()\" hour-step=\"1\" minute-step=\"1\" show-meridian=\"true\" class=\"d-timepicker d-timepicker__no-label\" ng-disabled=\"rxConfiguration.propertiesByName.timeDisabled\" ng-hide=\"rxConfiguration.propertiesByName.timeHidden\"></uib-timepicker></div></div></div></div>"
  );
  ...
  $templateCache.put('scripts/view-components/generic-card-widget/com-vyom-vyomlib-generic-card-widget-design.directive.html',
    "<div class=\"row\"><div class=\"col-lg-4\"><span class=\"d-icon-layout_preview\" style=\"font-size: 100px;text-align: center\"></span></div><div><h3>This component can be used to display number of cards on the view based upon the configured records at the backend.</h3></div></div>"
  );


  $templateCache.put('scripts/view-components/generic-card-widget/com-vyom-vyomlib-generic-card-widget.directive.html',
    "<!DOCTYPE HTML><html><head><meta charset=\"utf-8\"><meta http-equiv=\"x-ua-compatible\" content=\"ie=edge\"><title>Generic Card widget View</title><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head><body><div class=\"all-content-wrapper\" style=\"display: flex;flex-wrap: wrap\"><div class=\"{{perRowCardLength}} col-xs-12\" style=\"padding: 3px;display: flex\" ng-repeat=\"x in textData\"><div class=\"analytics-sparkle-line reso-mg-b-30 w3-{{Color}}\" style=\"display: flex;flex-direction: column;flex:1\" tabindex=\"0\"><div class=\"analytics-content\" style=\"display: flex;justify-content: space-between;gap: 5px\" ng-click=\"setSelectedCardInstanceId(x[179]);executeAction(actionguid);\" role=\"button\"><div style=\"display: flex;flex-direction: column;flex: 1\"><h3 style=\"font-size: 1.2em; color: #fff;margin: 0.3em 0em;font-family: 'Carrois Gothic', sans-serif\">{{x[count]}}</h3><h4 style=\"font-size: 1.5em; color: #fff;margin: 0.3em 0em;font-family: 'Carrois Gothic', sans-serif\">{{x[header]}}</h4><p>{{x[note]}}</p></div><div style=\"display: flex;flex-direction: column\" ng-init=\"fetchPicture(x[179])\"><img style=\"height: 110px\" src=\"{{pictureData[x[179]]}}\"></div></div><div class=\"analytics-content\" ng-style=\"{display: tooltipConfig === 'Show' ? 'flex' : 'none'}\" style=\"flex-direction: row;margin-top: auto\"><p class=\"d-icon-info_circle\" style=\"font-size: small;margin: 5px\"><span class=\"col-lg-10 col-md-9 col-xs-9 tooltiptext\">{{x[tooltip]}}</span></p></div></div></div><!-- <div style=\"text-align: right\">\n" +
    "      <span>\n" +
    "        <button class=\"d-button d-icon-right-angle_up d-button_secondary\" style=\"color: #333; border-color: #999; background-color: #fff;\" ng-hide=\"9 <= 3\" ng-click=\"3 = 3 - 3\">show less...</button>\n" +
    "        <button class=\"d-button d-icon-right-angle_down d-button_secondary\" style=\"color: #333; border-color: #999; background-color: #fff;\" ng-hide=\"9=== 3 \" ng-click=\"limit = limit + cardlimit\">show more...</button>\n" +
    "      </span>\n" +
    "    </div> --><div class=\"clearfix\"></div></div></body></html>"
  );
