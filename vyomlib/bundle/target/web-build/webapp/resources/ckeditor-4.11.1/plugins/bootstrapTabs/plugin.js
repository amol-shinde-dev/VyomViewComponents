...
CKEDITOR.plugins.add('bootstrapTabs', {
    ...
    editor.addCommand('bootstrapTabs', new CKEDITOR.dialogCommand('bootstrapTabsDialog', {
      allowedContent: 'div ul li a[role,href,id,aria-*,data-number-of-tabs,data-tab-set-title,data-toggle](bootstrap-tabs,nav,nav-tabs,tab-link,nav-fill,nav-item ,nav-link,active,tab-content,tab-pane,tab-pane-content)'
    }));
