...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.info-card')
        .directive('comVyomVyomlibInspectorInfoCardBgcolor', function (RX_RECORD_DEFINITION, $timeout) {
            return {
                restrict: 'E',
                templateUrl: 'scripts/view-components/info-card/com-vyom-vyomlib-inspector-info-card-bgcolor.directive.html',
