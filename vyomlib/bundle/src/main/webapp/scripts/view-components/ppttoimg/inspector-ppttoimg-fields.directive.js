...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.ppttoimg').directive('comVyomVyomlibInspectorPpttoimgFields', function (RX_RECORD_DEFINITION, $timeout) {
        return {
            restrict: 'E',
            templateUrl: 'scripts/view-components/ppttoimg/com-vyom-vyomlib-inspector-ppttoimg-fields.directive.html',
