(function () {
  ...
  angular.module('com.vyom.vyomlib.view-components.card-widget')
    .directive('comVyomVyomlibInspectorCardWidgetAttachment', function (RX_RECORD_DEFINITION, $timeout) {
      return {
        restrict: 'E',
        templateUrl: 'scripts/view-components/card-widget/com-vyom-vyomlib-inspector-card-widget-attachment.directive.html',
