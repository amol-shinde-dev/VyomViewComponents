...
(function () {
  ...
  angular.module('com.vyom.vyomlib.view-components.service-health-dashboard')
    .directive('comVyomVyomlibInspectorServiceHealthDashboardFields',
      function (RX_RECORD_DEFINITION, $timeout) {
        return {
          restrict: 'E',
          templateUrl: 'scripts/view-components/service-health-dashboard/com-vyom-vyomlib-inspector-service-health-dashboard-fields.directive.html',
