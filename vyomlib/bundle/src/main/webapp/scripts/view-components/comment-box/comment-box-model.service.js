...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.comment-box').factory('comVyomVyomlibCommentBoxModel', function (rxViewComponentModel, rxRecordDefinitionResource) {
