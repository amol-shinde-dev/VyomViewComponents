...
(function() {
    ...
    angular.module('com.vyom.vyomlib.view-components.service-health')
        .directive('comVyomVyomlibInspectorServiceHealthFields3',
            function(RX_RECORD_DEFINITION, $timeout) {
                return {
                    restrict: 'E',
                    templateUrl: 'scripts/view-components/service-health/com-vyom-vyomlib-inspector-service-health-fields3.directive.html',
                    ...
                    link: function($scope) {
                        ...
                        function init() {
                            ...
                            $scope.$watch('cell.recordDefinition3', initializeFields);
                        ...
                        function initializeFields() {
                            if ($scope.cell.recordDefinition3) {
                        ...
                        function getFields() {
                            return _($scope.cell.recordDefinition3.fieldDefinitions)
