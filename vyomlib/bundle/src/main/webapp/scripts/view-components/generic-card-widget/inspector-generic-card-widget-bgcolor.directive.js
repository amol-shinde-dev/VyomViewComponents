...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.generic-card-widget')
        .directive('comVyomVyomlibInspectorGenericCardWidgetBgcolor', function (RX_RECORD_DEFINITION, $timeout) {
            return {
                restrict: 'E',
                ...
                link: function ($scope) {
                    ...
                    $scope.names = ["erric_default", "Gray1", "Gray2", "white", "white-no-border", "white-no-border-shadow", "blue", "red", "green", "orange", "lime", "gray", "black", "pink", "brown", "dark-grey", "purple", "deep-purple", "indigo", "light-blue", "cyan", "teal", "light-green", "khaki", "yellow", "amber", "deep-orange", "blue-grey", "light-grey"];
