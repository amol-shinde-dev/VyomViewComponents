(function () {
  ...
  angular.module('com.vyom.vyomlib.view-components.generic-card-widget')
    .directive('comVyomVyomlibInspectorGenericCardWidgetAttachment', function (RX_RECORD_DEFINITION, $timeout) {
      return {
        restrict: 'E',
        templateUrl: 'scripts/view-components/generic-card-widget/com-vyom-vyomlib-inspector-generic-card-widget-attachment.directive.html',
