(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.learning-portal').directive('comVyomVyomlibInspectorLearningPortalInteger', function (RX_RECORD_DEFINITION, $timeout) {
        return {
            restrict: 'E',
            templateUrl: 'scripts/view-components/learning-portal/com-vyom-vyomlib-inspector-learning-portal-integer.directive.html',
