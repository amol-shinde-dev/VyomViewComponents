(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.portal-preview').directive('comVyomVyomlibInspectorPortalPreviewInteger', function (RX_RECORD_DEFINITION, $timeout) {
        return {
            restrict: 'E',
            templateUrl: 'scripts/view-components/portal-preview/com-vyom-vyomlib-inspector-portal-preview-integer.directive.html',
