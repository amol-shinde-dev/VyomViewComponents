(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.portal-preview').factory('comVyomVyomlibPortalPreviewModel', function (rxViewComponentModel, rxRecordDefinitionResource) {
