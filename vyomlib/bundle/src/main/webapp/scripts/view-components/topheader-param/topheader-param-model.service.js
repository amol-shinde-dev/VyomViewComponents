...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.topheader-param').factory('comVyomVyomlibTopheaderParamModel', function (rxViewComponentModel, rxRecordDefinitionResource) {
