...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.event-calendar').factory('comVyomVyomlibEventCalendarModel', function (rxViewComponentModel, rxRecordDefinitionResource) {
