...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.event-calendar').directive('comVyomVyomlibInspectorEventCalendarFields', function (RX_RECORD_DEFINITION, $timeout) {
        return {
            restrict: 'E',
            templateUrl: 'scripts/view-components/event-calendar/com-vyom-vyomlib-inspector-event-calendar-fields.directive.html',
