...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.event-calendar').directive('comVyomVyomlibInspectorEventCalendarGuid', function (RX_RECORD_DEFINITION, $timeout, rxRecordInstanceDataPageResource) {
        return {
            restrict: 'E',
            templateUrl: 'scripts/view-components/event-calendar/com-vyom-vyomlib-inspector-event-calendar-guid.directive.html',
