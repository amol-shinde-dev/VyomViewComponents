...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.recent-activity').factory('comVyomVyomlibRecentActivityModel', function (rxViewComponentModel, rxRecordDefinitionResource) {
