...
It is used in "d3-gauge-design.service.js".
...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.d3-gauge')
        .directive('comVyomVyomlibInspectorD3GaugeFiedSelect', function (RX_RECORD_DEFINITION) {
            return {
                restrict: 'E',
                templateUrl: 'scripts/view-components/d3-gauge/com-vyom-vyomlib-inspector-d3-gauge-field-select.directive.html',
