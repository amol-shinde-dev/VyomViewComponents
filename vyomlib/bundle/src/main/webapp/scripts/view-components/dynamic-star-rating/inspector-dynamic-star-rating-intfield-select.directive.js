...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.dynamic-star-rating')
        .directive('comVyomVyomlibInspectorDynamicStarRatingIntfieldSelect', function (RX_RECORD_DEFINITION) {
            return {
                restrict: 'E',
                templateUrl: 'scripts/view-components/dynamic-star-rating/com-vyom-vyomlib-inspector-dynamic-star-rating-intfield-select.directive.html',
