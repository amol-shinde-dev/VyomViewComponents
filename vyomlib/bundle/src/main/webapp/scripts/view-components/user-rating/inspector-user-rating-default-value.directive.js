...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.user-rating').directive('comVyomVyomlibInspectorUserRatingDefaultValue', function () {
        return {
            restrict: 'E',
            templateUrl: 'scripts/view-components/user-rating/com-vyom-vyomlib-inspector-user-rating-default-value.directive.html',
