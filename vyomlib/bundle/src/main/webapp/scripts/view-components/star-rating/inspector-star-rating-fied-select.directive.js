...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.star-rating').directive('comVyomVyomlibInspectorStarRatingFieldSelect', function (RX_RECORD_DEFINITION) {
        return {
            restrict: 'E',
            templateUrl: 'scripts/view-components/star-rating/com-vyom-vyomlib-inspector-star-rating-field-select.directive.html',
