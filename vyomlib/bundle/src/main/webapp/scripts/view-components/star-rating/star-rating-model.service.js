...
used in "comVyomVyomlibStarRatingsDesign" factory (file "star-ratings-design-service.js").
*/
(function () {
    'use strict';

    angular.module('com.vyom.vyomlib.view-components.star-rating').factory('comVyomVyomlibStarRatingModel', function (rxViewComponentModel, rxRecordDefinitionResource) {
