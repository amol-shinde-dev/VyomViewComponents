...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.star-rating')
        .factory('comVyomVyomlibStarRatingDesign', function (comVyomVyomlibStarRatingModel, rxGUID, RX_DEFINITION_PICKER) {
                    ...
                    inputs: {
                        rxData: {
                            ...
                            fieldId: {
                                ...
                                type: 'com-vyom-vyomlib-inspector-star-rating-field-select', //  set our directive as editor
                                group: 'general',
                                index: 3
                            },
                            stars: {
            ...
            return {
                ...
                getModel: function (componentDefinition, componentDescriptor) {
                    return new comVyomVyomlibStarRatingModel(getRxConfig(componentDefinition, componentDescriptor));
                }
            };
        });
})();